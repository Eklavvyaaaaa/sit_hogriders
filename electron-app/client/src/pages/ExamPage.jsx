        ...
        <div className="flex flex-col h-screen bg-[#f0f7ff] font-inter">
            ...
            <div className="bg-white px-8 py-4 flex justify-between items-center shadow-sm border-b border-slate-100 shrink-0">
                <div className="flex items-center space-x-4">
                    ...
                    <span className="text-xs bg-slate-100 px-3 py-1 rounded-full text-slate-500 font-bold uppercase tracking-wider">Midterm</span>
                </div>
                ...
                <div className="flex items-center space-x-8">
                    ...
                    <div className="flex items-center px-4 py-2 bg-teal-50 border border-teal-100 rounded-lg">
                        <span className="text-xs font-bold text-teal-600 uppercase tracking-widest mr-2">ATI Score</span>
                        <span className="font-black text-teal-700">84</span>
                    </div>
                </div>
            </div>
                    ...
                    <div className="max-w-3xl w-full pb-32">
                        ...
                        <div className="flex justify-between mt-8">
                            ...
                            {currentIndex < examData.questions.length - 1 ? (
                                ...
                                <button
                                    onClick={() => { if (window.confirm("Submit your answers?")) handleSubmit(); }}
                                    className="px-10 py-3 bg-green-600 text-white rounded-xl font-bold hover:bg-green-700 shadow-md shadow-green-100 transition-all"
                                >
                                    Finish Assessment
                                </button>
                            )}
